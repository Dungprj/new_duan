...
<body>
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                    name="name" placeholder="Nhập tên" value="{{ old('name') }}" required>
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control @error('confirm_password') is-invalid @enderror"
                    id="confirm_password" name="confirm_password" placeholder="Nhập lại mật khẩu" disabled required>
    ...
    <script>
        ...
        password.oninput = () => {
            // Nếu mật khẩu đã được nhập, bỏ thuộc tính disabled của trường xác nhận mật khẩu
            if (password.value.length > 0) {
                confirmPasswordField.removeAttribute('disabled');
            } else {
                // Nếu mật khẩu trống, thêm thuộc tính disabled vào trường xác nhận mật khẩu
